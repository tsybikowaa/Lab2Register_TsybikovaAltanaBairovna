...
using System.Text.RegularExpressions;
    ...
    {
        string login = "ALTANA123";
        string password = "Алтана6!";
        string password2 = "Алтана6!";

        var result = CheckRegister(login, password, password2);
        ...
        {
            Console.WriteLine("Ошибка регистрации: " + result.Item2);
        }
